...
function examelSubscribe(){
  ...
  fetch('https://app.kit.com/forms/9220999/subscriptions',{method:'POST',headers:{'Content-Type':'application/x-www-form-urlencoded'},body:'email_address='+encodeURIComponent(email)})
