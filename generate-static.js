...
<div class="container">
  ...
  <div class="chars">
    ...
    <div class="char-card"><div class="char-svg"><svg width="110" height="130" viewBox="0 0 120 140" xmlns="http://www.w3.org/2000/svg"><ellipse cx="60" cy="105" rx="36" ry="8" fill="rgba(5,150,105,0.12)"/><rect x="18" y="70" width="84" height="54" rx="18" fill="#F8F8F8"/><rect x="30" y="76" width="60" height="28" rx="12" fill="#0D9488"/><ellipse cx="34" cy="122" rx="14" ry="8" fill="#0F766E"/><ellipse cx="86" cy="122" rx="14" ry="8" fill="#0F766E"/><ellipse cx="60" cy="66" rx="42" ry="46" fill="#FDBCB4"/><ellipse cx="60" cy="26" rx="42" ry="24" fill="#0A0500"/><circle cx="32" cy="28" r="22" fill="#0A0500"/><circle cx="88" cy="28" r="22" fill="#0A0500"/><ellipse cx="32" cy="50" rx="12" ry="6" fill="#F59E0B"/><ellipse cx="88" cy="50" rx="12" ry="6" fill="#F59E0B"/><ellipse cx="32" cy="49" rx="9" ry="4" fill="#FBBF24"/><ellipse cx="88" cy="49" rx="9" ry="4" fill="#FBBF24"/><rect x="20" y="54" width="14" height="52" rx="7" fill="#0A0500"/><rect x="86" y="54" width="14" height="52" rx="7" fill="#0A0500"/><circle cx="27" cy="95" r="6" fill="#F59E0B" stroke="#0A0500" stroke-width="1.5"/><circle cx="93" cy="95" r="6" fill="#10B981" stroke="#0A0500" stroke-width="1.5"/><circle cx="48" cy="66" r="14" fill="white"/><circle cx="72" cy="66" r="14" fill="white"/><circle cx="49" cy="67" r="9" fill="#3D1F00"/><circle cx="73" cy="67" r="9" fill="#3D1F00"/><circle cx="52" cy="63" r="4.5" fill="white"/><circle cx="76" cy="63" r="4.5" fill="white"/><circle cx="49" cy="68" r="3" fill="#0A0500"/><circle cx="73" cy="68" r="3" fill="#0A0500"/><path d="M46 86 Q60 98 74 86" stroke="#C05030" stroke-width="3" fill="none" stroke-linecap="round"/><circle cx="36" cy="78" r="12" fill="#FF9999" opacity="0.2"/><circle cx="84" cy="78" r="12" fill="#FF9999" opacity="0.2"/></svg></div><div class="char-name">Zoe</div><div class="char-role">Science Guide</div></div>
