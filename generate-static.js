...
.char-emoji{font-size:32px;margin-bottom:4px;}
...
<div class="container">
  ...
  <div class="chars">
    <div class="char-card"><div class="char-emoji">📐</div><div class="char-name">Maya</div><div class="char-role">Math Guide</div></div>
    <div class="char-card"><div class="char-emoji">📚</div><div class="char-name">Leo</div><div class="char-role">English Guide</div></div>
    <div class="char-card"><div class="char-emoji">🔬</div><div class="char-name">Zoe</div><div class="char-role">Science Guide</div></div>
    <div class="char-card"><div class="char-emoji">⚡</div><div class="char-name">Max</div><div class="char-role">Drills Guide</div></div>
  </div>
  <div class="for-grid">
    <div class="for-card">
      <h3>For Teachers</h3>
