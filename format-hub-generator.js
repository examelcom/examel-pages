...
<body>
  ...
  <div style="background:#1C1526;border-top:5px solid #DC2626;padding:0 20px;position:relative;overflow:hidden;">
    <div style="max-width:1100px;margin:0 auto;padding:52px 180px 48px 48px;position:relative;z-index:2;">
      ...
      <p style="font-size:16px;color:rgba(255,255,255,0.5);max-width:520px;line-height:1.75;margin-bottom:24px;">${drillPages.length || 500}+ free printable math drills for Grades 1–6. Build fact fluency fast. Timed practice with answer keys included.</p>
