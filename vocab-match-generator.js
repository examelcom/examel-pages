  ...
  <div class="ws-container">
    ...
    <div class="preview-section">
      ...
      <div class="preview-grid">
        <div>
          <p class="preview-label">Page 1 — Vocabulary Match</p>
          <a href="${ws.preview_p1_url}" target="_blank">
            <img src="${ws.preview_p1_url}"
              alt="Free Grade ${ws.grade} ${capitalize(ws.subject)} vocabulary match worksheet — ${formatTopic(ws.topic)} — Common Core ${ws.ccss_standard}"
        ...
        <div>
          ...
          <a href="${ws.preview_p2_url}" target="_blank">
            <img src="${ws.preview_p2_url}"
              alt="Answer key — Grade ${ws.grade} ${capitalize(ws.subject)} vocabulary match — ${formatTopic(ws.topic)} — teacher and parent use only"
              loading="lazy" width="850" height="1100"
              class="preview-img">
          </a>
        </div>
